"""
Django settings for H&E Medicinal project.
...
MANAGERS = ADMINS
EMAIL_SUBJECT_PREFIX = '[H&E Medicinal] '  # subject prefix for managers & admins
...
# Email config
DEFAULT_FROM_EMAIL = "info@hemedicinal.com"
SERVER_EMAIL = "server@hemedicinal.com"
